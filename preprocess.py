...
def process_audio_file(vfile, args):
    vidname = os.path.basename(vfile).split(".")[0]
    dirname = os.path.dirname(vfile).split(os.sep)[-1]  # Use os.sep to handle both Windows and Unix path separators
...
def main(args):
    print("Started processing with {} GPUs".format(args.ngpu))
...
#python preprocess.py --data_root "C:\Users\David\Desktop\dataset\generated_clips" --preprocessed_root "C:\Users\David\Desktop\dataset\preprocess" --batch_size 3  